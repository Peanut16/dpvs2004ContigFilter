...
This sample module contains one small method that filters contigs.
    ...
    def run_dpvs2004ContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_dpvs2004ContigFilter
        ...
        if not isinstance(output, dict):
            raise ValueError('Method run_dpvs2004ContigFilter return value ' +
